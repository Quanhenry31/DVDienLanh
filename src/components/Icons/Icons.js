...
export const CategoryIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
    ...
    >
        ...
        <path d="M18 24h12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <path d="M24 18v12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
);

export const CategoryActiveIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
    ...
    >
        <circle cx="24" cy="24" r="20" fill="#FFD700" />
        <path d="M18 18h12v12H18z" fill="#fff" />
        <path d="M18 24h12" stroke="#fff" strokeWidth="2" strokeLinecap="round" />
        <path d="M24 18v12" stroke="#fff" strokeWidth="2" strokeLinecap="round" />
    </svg>
);

export const BrandIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const BrandActiveIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
    ...
    >
        ...
        <path d="M20 20h8v8h-8z" fill="#fff" />
    </svg>
);

export const VoucherIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
    ...
    >
        ...
        <path d="M20 20h8v8h-8z" fill="#D9D9D9" />
    </svg>
);

export const VoucherActiveIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
    ...
    >
        ...
        <path d="M20 20h8v8h-8z" fill="#FFD700" />
    </svg>
);
